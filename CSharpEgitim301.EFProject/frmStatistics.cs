...
namespace CSharpEgitim301.EFProject
{
    public partial class frmStatistics : Form
    {
        ...
        private void frmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblTürkiyeCapacity.Text = db.Location.Where(x => x.Country == "Türkiye").Average(y => y.Capacity).ToString();
            ...
            var nerimanId= db.Guide.Where(x=>x.GuideName=="Neriman").Select(y=>y.GuideId).FirstOrDefault(); 
            lblNerimanLocationCount .Text=db.Location.Where(x=>x.GuideId==nerimanId).Count().ToString();
        }
    }
}
